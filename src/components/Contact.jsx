  ...
  const handleSubmit = (e) => {
    ...
    emailjs.send(
      ...
      'template_cc0fhuf',
      {
        ...
        to_email: 'harshitbhan2004@gmail.com',
    ...
    .then(() => {
      ...
      formRef.current.reset(); // ✅ Fix: Reset form (optional)
    })
    .catch((error) => {
      setLoading(false);
      console.log(error);
    ...
    <div className='xl:mt-12 xl:flex-row flex-col-reverse flex gap-10 overflow-hidden'>
      <motion.div variants={slideIn("left", "tween", 0.2, 1)} className='flex-[0.75] bg-black-100 p-8 rounded-2xl'> 
        ...
        <form ref={formRef} onSubmit={handleSubmit} className='mt-12 flex flex-col gap-8'>
          ...
          <button type="submit" className='bg-tertiary py-3 px-8 font-bold shadow-md shadow-primary outline-none w-fit text-white rounded-xl '>
